...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fueller.Domain.Model.Audit.AuditMetadata<Fueller.Domain.Model.Vehicles.Vehicle>", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VehiclesAuditMetadata", (string)null);
                });

            modelBuilder.Entity("Fueller.Domain.Model.Audit.AuditRecord<Fueller.Domain.Model.Vehicles.Vehicle>", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("Auditable")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Fueller.Domain.Model.Audit.AuditMetadata<Fueller.Domain.Model.Vehicles.Vehicle>", b =>
                {
                    b.HasOne("Fueller.Domain.Model.Audit.AuditRecord<Fueller.Domain.Model.Vehicles.Vehicle>", null)
                        .WithMany("Metadata")
            ...
            modelBuilder.Entity("Fueller.Domain.Model.Audit.AuditRecord<Fueller.Domain.Model.Vehicles.Vehicle>", b =>
                {
                    b.HasOne("Fueller.Domain.Model.Vehicles.Vehicle", null)
